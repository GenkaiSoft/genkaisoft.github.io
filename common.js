var beforestr = `<nav class="navbar navbar-expand-sm navbar-dark bg-dark mb-3 p-0">
            <div class="container-fluid">
                <img class="navbar-brand" src="https://genkaisoft.github.io/assets/logo/japanese.png" width="64px">
...
var afterstr = `<footer>
    <strong>
        <a href=https://github.com/brain-hackers/README/blob/main/assets.md>
            限界やちゃんは Brain Hackers により puhitaku 氏の責任のもと CC BY-SA 4.0 でライセンスされています
        </a>
        。<br>
